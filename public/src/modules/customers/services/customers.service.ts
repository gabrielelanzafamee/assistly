...
export class CustomersService {
  ...
  public fetchCustomers(limit = 12, offset = 0): Observable<ICustomerListResponse> {
    return this.apiService.get<ICustomerListResponse>(`customers?limit=${limit}&offset=${offset}`).pipe(
      catchError((err) => {
